...
<div  style="width: 100px;height: 100px;float: right; margin:15px 15px 15px 15px" class="xh"><img style="width:99%;height:80px" src="{{url('./liwu/xianhua.png')}}" alt=""><p style="text-align:center">1积分</p></div>
<div  style="width: 100px;height: 100px;float: right; margin:15px 15px 15px 15px" class="zs"><img style="width:99%;height:80px" src="{{url('./liwu/zs.jpg')}}" alt=""><p style="text-align:center">10积分</p></div>
<div  style="width: 100px;height: 100px;float: right; margin:15px 15px 15px 15px" class="pc"><img style="width:99%;height:80px" src="{{url('./liwu/paoche.gif')}}" alt=""><p style="text-align:center">100积分</p></div>
<div  style="width: 100px;height: 100px;float: right; margin:15px 15px 15px 15px" class="hj"><img style="width:99%;height:80px" src="{{url('./liwu/hj.jpg')}}" alt=""><p style="text-align:center">1000积分</p></div>
<div  style="width: 100px;height: 100px;float: right; margin:15px 15px 15px 15px" class="fj"><img style="width:99%;height:80px" src="{{url('./liwu/feiji.gif')}}" alt=""><p style="text-align:center">10000积分</p></div>
